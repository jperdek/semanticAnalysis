...
class ExtractFromTree:
    ...
    def extract_info_from_trees_in_weir_dataset(percentage_chosen, extracted_data_path):
        extracted_data = dict()
        ExtractFromTree.parse_files_from_domain_directory("./videogame", percentage_chosen, extracted_data, "videogame")
        ExtractFromTree.parse_files_from_domain_directory("./book", percentage_chosen, extracted_data, "book")
        ExtractFromTree.parse_files_from_domain_directory("./soccer", percentage_chosen, extracted_data, "soccer")
        ExtractFromTree.parse_files_from_domain_directory("./finance", percentage_chosen, extracted_data, "finance")
    ...
    def extract_info_from_trees_in_swde_dataset(percentage_chosen, extracted_data_path):
        extracted_data = dict()
        ExtractFromTree.parse_files_from_domain_directory("./auto", percentage_chosen, extracted_data, "auto", True)
        ExtractFromTree.parse_files_from_domain_directory("./book2", percentage_chosen, extracted_data, "book", True)
        ExtractFromTree.parse_files_from_domain_directory("./camera", percentage_chosen, extracted_data, "camera", True)
        ExtractFromTree.parse_files_from_domain_directory("./job", percentage_chosen, extracted_data, "job", True)
        ExtractFromTree.parse_files_from_domain_directory("./movie", percentage_chosen, extracted_data, "movie", True)
        ExtractFromTree.parse_files_from_domain_directory("./nbaplayer", percentage_chosen, extracted_data, "nbaplayer",
                                                          True)
        ExtractFromTree.parse_files_from_domain_directory("./restaurant", percentage_chosen, extracted_data,
                                                          "restaurant", True)
        ExtractFromTree.parse_files_from_domain_directory("./university", percentage_chosen, extracted_data,
                                                          "university", True)
        save_as_json(extracted_data, extracted_data_path)
...
class ProcessWeirLxml:
    ...
    def create_trees_for_domain_in_weir_dataset():
        SOMLxml.parse_tree("d:\\dipldatasets\\weir\\prepdataset\\videogame", "./videogame/tree_videogame.json")
        SOMLxml.parse_tree("d:\\dipldatasets\\weir\\prepdataset\\book", "./book/tree_book.json")
        SOMLxml.parse_tree("d:\\dipldatasets\\weir\\prepdataset\\soccer", "./soccer/tree_soccer.json")
        SOMLxml.parse_tree("d:\\dipldatasets\\weir\\prepdataset\\finance", "./finance/tree_finance.json")
...
class ProcessWeirBeautifulSoup:
    ...
    def create_trees_for_domain_in_weir_dataset_beautiful_soup():
        SOMBeautifulSoup.parse_tree_beautiful_soup("d:\\dipldatasets\\weir\\prepdataset\\videogame",
                                                   "./videogame/tree_videogame.json")
        SOMBeautifulSoup.parse_tree_beautiful_soup("d:\\dipldatasets\\weir\\prepdataset\\book", "./book/tree_book.json")
        SOMBeautifulSoup.parse_tree_beautiful_soup("d:\\dipldatasets\\weir\\prepdataset\\soccer",
                                                   "./soccer/tree_soccer.json")
        SOMBeautifulSoup.parse_tree_beautiful_soup("d:\\dipldatasets\\weir\\prepdataset\\finance",
                                                   "./finance/tree_finance.json")
...
class ProcessSwdeBeautifulSoup:
    ...
    def create_trees_for_domain_in_swde_dataset_beautiful_soup():
        SOMBeautifulSoup.parse_tree_beautiful_soup("d:\\dipldatasets\\swde\\dataset\\auto",
                                                   "./auto/tree_auto.json")
        SOMBeautifulSoup.parse_tree_beautiful_soup("d:\\dipldatasets\\swde\\dataset\\book", "./book/tree_book2.json")
        SOMBeautifulSoup.parse_tree_beautiful_soup("d:\\dipldatasets\\swde\\dataset\\camera",
                                                   "./camera/tree_camera.json")
