...
def create_json_from_wordnet():
    domain_names = get_all_wordnet_domains("D://yago/wordnet/yagoWordnetDomains.tsv", "wordnet/domains.json", True)
    find_associated_parts("D://yago/wordnet/yagoWordnetDomains.tsv", domain_names, "wordnet/domain-parts.json", True)

    domain_names = get_all_wordnet_domains("D://yago/wordnet/yagoWordnetDomains.tsv", "wordnet/domains.json", True)
    find_all_narrowers("D://yago/wordnet/yagoWordnetDomainHierarchy.tsv", domain_names, "wordnet/domains-narrowers.json"
                       , True)

    find_yago_labels_and_types("D://yago/ttl/yagoWordnetDomains.ttl", "wordnet/yago_wordnet_assoc.json", True)


def create_json_subclasses():
    domain_parts = load_as_json("wordnet/domain-parts.json")
    get_wordnet_subclasses_from_wiki(domain_parts, ["D://yago/ttl/yagoSimpleTaxonomy.ttl"], "wordnet/subclasses.json",
                                     True)
