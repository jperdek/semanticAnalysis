...
def readability_analysis_weir():
    ...
    print('here')
    ReadabilityAnalyser.check_readability_from_file("../pageAnalyser/CETD/extractor.json",
                                                    "d:\\dipldatasets\\weir\\weir_extractor_readability.json")
    ReadabilityAnalyser.check_readability_from_file("../pageAnalyser/CETD/edgareExtractor.json",
                                                    "d:\\dipldatasets\\weir\\weir_edgareExtractor_readability.json")
    ReadabilityAnalyser.check_readability_from_file("../pageAnalyser/CETD/variantExtractor.json",
                                                    "d:\\dipldatasets\\weir\\weir_variantExtractor_readability.json")
    ReadabilityAnalyser.check_readability_from_file("../pageAnalyser/plain_text.json",
