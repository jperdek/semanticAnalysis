...
if __name__ == "__main__":
    ...
    result_keybert_dict = keybert_keyword_extractor("../../../../../../output/pageAnalyser/CETD/extractor.json", (1, 1))
    save_as_json(result_keybert_dict, '../../../../../../output/keywordExtraction/keybert_CETD_extrctor.json')
