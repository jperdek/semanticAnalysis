...
# FROM https://github.com/RDFLib/pyTARQL/blob/develop/pytarql/pytarql.py
...
def run():
    """Invoke entry point."""
    #PyTarql().transform(['-h'], output='D://yago/wordnet/yagoWordnetDomains.ttl')]
    #http://www.bobdc.com/blog/tarql/
    PyTarql().transform(['D://yago/wordnet/save.ttl', 'D://yago/wordnet/example.rq'], output=sys.stdout)
    #PyTarql().transform(['D://yago/wordnet/save.ttl', 'D://yago/wordnet/yagoWordnetDomains1.tsv'], output=sys.stdout)
