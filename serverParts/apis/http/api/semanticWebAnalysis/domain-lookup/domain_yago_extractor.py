...
def find_unique_predicates_of_facts():
    get_unique_values("D://yago/yagoFacts.tsv", '\t', 2,
                      "../../../../../../output/domain-lookup/yagoProcessed/yagoFactsPredicates.txt", True)
    get_unique_values("D://yago/yagoDateFacts.tsv", '\t', 2,
                      "../../../../../../output/domain-lookup/yagoProcessed/yagoDateFactsPredicates.txt", True)
    get_unique_values("D://yago/ttl/yagoLiteralFacts.ttl", '\t', 1,
                      "../../../../../../output/domain-lookup/yagoProcessed/yagoLiteralFactsPredicates.txt",
                      True)
    get_unique_values("D://yago/ttl/yagoMetaFacts.ttl", '\t', 1,
                      "../../../../../../output/domain-lookup/yagoProcessed/yagoMetaFactsPredicates.txt", True)


def find_unique_predicates_wikipedia():
    get_unique_values("D://yago/ttl/yagoConteXtFacts_en.ttl", '\t', 1,
                      "../../../../../../output/domain-lookup/yagoProcessed/yagoConteXtFactsEn.txt", True)
...
def book_retrieval_strategy1(file_paths_dictionary):
    output_file = "../../../../../../output/domain-lookup/yagoProcessed/book_strategy1.ttl"
    add_header_to_created_file(output_file)
