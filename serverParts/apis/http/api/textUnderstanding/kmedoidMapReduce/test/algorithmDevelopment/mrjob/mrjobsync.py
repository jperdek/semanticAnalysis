...
def kmedoid():
    remove_old = True
    previous_data_file_path = '/serverParts/apis/http/api/textUnderstanding/kmedoidMapReduce/test/mrjob/dataonly.txt'
    previous_cluster_file_path = '/serverParts/apis/http/api/textUnderstanding/kmedoidMapReduce/test/mrjob/clusteronly.txt'
