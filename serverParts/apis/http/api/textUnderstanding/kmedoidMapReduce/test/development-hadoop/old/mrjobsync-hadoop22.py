...
class KMedoid(MRJob):
    ...
    FILES = ['clusteronly.txt', 'dataonly.txt']
    ...
    def reducer_final(self):
        ...
        for index, cluster_dict in enumerate(self.cluster_connections.values()):
            ...
            if cluster_name in categorization_cluster_dict:
                ...
                yield ("C\t" + cluster_name + "\t" + json.dumps(cluster) + "\t" + self.real_cluster_names[cluster_name] + "\n", "")
        ...
        for previos_file_line in self.data_lines:
